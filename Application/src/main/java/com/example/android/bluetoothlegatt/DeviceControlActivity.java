...
public class DeviceControlActivity extends Activity {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                //final byte[] insertSomething = {(byte)'v'};
                //byte[] txBytes = new byte[insertSomething.length + rxBytes.length];
                byte[] txBytes = new byte[rxBytes.length];
                ...
                System.arraycopy(rxBytes, 0, txBytes, 0, rxBytes.length);
    ...
    public void seekBarr (){
        speedSeek = (SeekBar) findViewById(R.id.speedSeekBar);
        speedSeek.setProgress(6);
        rotationSeek = (SeekBar) findViewById(R.id.rotationSeekBar);
                ...
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                        if(mBluetoothLeService != null) {
                            mBluetoothLeService.writeCustomCharacteristic(97+i);
                        }
                    }
                    ...
                    public void onStopTrackingTouch(SeekBar seekBar) {
                        if(mBluetoothLeService != null) {
                            mBluetoothLeService.writeCustomCharacteristic(97+3);
                        }
                        speedSeek.setProgress(3);

                    }
                }
        );

        rotationSeek.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    @Override
                    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                        if(mBluetoothLeService != null) {
                            mBluetoothLeService.writeCustomCharacteristic(104+i);
                        }
                    }
                    ...
                    public void onStopTrackingTouch(SeekBar seekBar) {
                        if(mBluetoothLeService != null) {
                            mBluetoothLeService.writeCustomCharacteristic(104+3);
                        }
                        rotationSeek.setProgress(3);
